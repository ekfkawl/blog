...
#### 애플리케이션 아키텍처
![kakaoscan-diagram](/static/images/kakaoscan-diagram-app.jpg)

#### 인프라 아키텍처
![kakaoscan-diagram](/static/images/kakaoscan-diagram-infra.jpg)

#### DB 다이어그램
![kakaoscan-diagram](/static/images/kakaoscan-diagram-db.jpg)
...
구체적인 트러블슈팅 과정은 [hosthook-pay 회고]()에 별도로 정리해 두었습니다.
